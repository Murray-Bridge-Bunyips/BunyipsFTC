...
@Autonomous(name = "Blue Far Zone Auto (Human)")
public class BlueFarZoneHuman extends AutonomousBunyipsOpMode {
    ...
    protected void onReady(@Nullable RefCell<?> selectedOpMode) {
        ...
        damon.drive.makeTrajectory()
                ...
                .strafeToLinearHeading(new Vector2d(52, -60), Inches, -65, Degrees)

                .strafeToLinearHeading(new Vector2d(59, -60), Inches, -75, Degrees)
