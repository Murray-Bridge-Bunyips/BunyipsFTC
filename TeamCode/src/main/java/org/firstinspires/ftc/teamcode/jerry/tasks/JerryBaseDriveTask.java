...
public class JerryBaseDriveTask extends Task implements TaskImpl {

    private final JerryDrive drive;
    private final double x, y, r;

    public JerryBaseDriveTask(BunyipsOpMode opMode, double time, JerryDrive drive, double x, double y, double r) {
        super(opMode, time);
        this.drive = drive;
        this.x = x;
        this.y = y;
